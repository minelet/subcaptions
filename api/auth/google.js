...
module.exports = (req, res) => {
  // Never let this redirect be cached — it's what kicks off a specific
  // person's login attempt (carries a fresh one-time nonce). A cached copy
  // served to someone else, or replayed later, would be stale/wrong.
  ...
  const from = req.query && (req.query.from === 'admin' || req.query.from === 'editor') ? req.query.from : '';
