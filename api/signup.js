...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const result = await sql`INSERT INTO users (email, password_hash, is_admin, credits, credits_infinite) VALUES (${normalizedEmail}, ${passwordHash}, ${isAdmin}, 5, ${isAdmin}) RETURNING id, email, is_admin, credits, credits_infinite`;
